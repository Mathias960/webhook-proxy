...
module.exports = async (req, res) => {
  ...
  // Log pour debug
  console.log('API appelée:', req.url, req.method, req.query);
  ...
  try {
    ...
    // Support multiple parameter names (data, d, d., etc.)
    const data = req.query.data || req.query.d || req.query['d.'] || req.body?.data || req.body?.d || req.body?.['d.'];
